      ...
      <section className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-lg mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex space-x-4">
            ...
            <Link to="/register" className="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition-colors transform hover:scale-105 flex items-center">
              <span>Register</span>
              <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
